        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="resenas form content">
                    ...
                    <fieldset>
                        <legend><?= __('Añadir Reseña') ?></legend>
                        ...
                        <?= $this->Form->hidden('cerveza_id', ['value' => $cerveza->id]); ?>
                        <?= $this->Form->control('comentario', ['label' => 'Comentario', 'type' => 'textarea', 'class' => 'my-3 rounded']); ?>
                    </fieldset>
                    <?= $this->Form->button('Enviar reseña', ['class' => 'mt-3 col-3 btn btn-secondary', 'id' => 'Eresena', 'type' => 'submit']); ?>
                    <?= $this->Form->end() ?>
                </div>
            </div>
